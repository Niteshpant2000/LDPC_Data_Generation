...
writematrix(msg_matrix,'./msg/msg.txt')
writematrix(codeword_matrix,'./code_word/code_word.txt')
writematrix(Encoded_output,'./encoded_input_noise/encoded_input_noise.txt')
